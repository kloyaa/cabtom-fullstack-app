import {
  ...
  const Links = [
    { title: 'SMS Notifications', path: "/owner/sms-notifications" },
    { title: 'Accounts', path: "/owner/accounts" },
    { title: 'Registration', path: "/owner/registration" },
    { title: 'Sales', path: "/owner/sales" }
  ];
  ...
  function OwnerNavbar({ orderBtnFunction }) {
      ...
      <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
        ...
        <HStack spacing={8} alignItems={'center'}>
          <Box
              ...
              color={useColorModeValue("teal", "gray.300")}
              cursor={"pointer"}
              onClick={() => navigate("/dashboard/owner")}>CABTOM</Box>
